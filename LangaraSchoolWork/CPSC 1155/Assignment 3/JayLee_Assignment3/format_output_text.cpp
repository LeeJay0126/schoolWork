...
// C++ prgram for Assignment 3 Question 8
//
...
int main(){
    ...
    char randomDigit1 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit2 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit3 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit4 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit5 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit6 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit7 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit8 = static_cast<char>('0'+rand()%('0'-'9'+1));
    char randomDigit9 = static_cast<char>('0'+rand()%('0'-'9'+1));
    ...
    output << "|" << left << setw(12)<<"Name"<<"|"<<left<<setw(20)<<name1<<"|"<<left<<setw(20)<<name2<<"|"<<left<<setw(20)<<name3<<"|"<<endl;
    output << "|"<<left<<setw(12)<<"ID"<<"|"<<left<<setw(20)<<firstId<<"|"<<left<<setw(20)<<secondId<<"|"<<left<<setw(20)<<thirdId<<"|";
    output.close();
