...
public class FancyClock extends Application {
     ...
     * class that will decorate around the clock
     */
    private class Decorate{
        /**
         * method Decorate()
         * adds backboard, circle decoration, and line decoration around the clock
         */
        public Decorate(){
            ...
            Rectangle backBoard = new Rectangle(X,Y,width,height);
            backBoard.setFill(Color.TRANSPARENT);
            backBoard.setStroke(Color.LIGHTGRAY);
            backBoard.setStrokeWidth(3);
            ...
            for(int i = 0; i < 22; i ++){
                ...
                temp.setFill(Color.DARKGRAY);
                temp.setRadius(CirRadius);
                temp.setCenterX(x);
                temp.setCenterY(20);
                x += 20;
            ...
            Line line1 = new Line(483,11.5,483,488.5);
            line1.setStroke(Color.FIREBRICK);
            line1.setStrokeWidth(2);

            root.getChildren().add(line1);

            Line line2 = new Line(17,11.5,17,488.5);
