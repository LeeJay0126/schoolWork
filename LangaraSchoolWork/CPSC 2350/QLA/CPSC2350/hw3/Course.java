...
public class Course {
    ...
    private String name; //i.e. Software Practices
    private final String department; //i.e. CPSC
    private final int catalogNumber; //i.e. 2350
    ...
    private String meetingLocation; //i.e. A275
